...
@implementation MockAddressBook
	...
	@synthesize fakeSearchDuration = _fakeSearchDuration;
	...
	-(void) dealloc {
		UX_INVALIDATE_TIMER(_fakeSearchTimer);
		UX_SAFE_RELEASE(_delegates);
		UX_SAFE_RELEASE(_allNames);
		UX_SAFE_RELEASE(_names);
		[super dealloc];
	}
...
@implementation MockDataSource
	...
	-(NSArray *) sectionIndexTitlesForTableView:(UITableView *)tableView {
		return [[self class] lettersForSectionsWithSearch:YES summary:NO];
	}
	...
	-(void) tableViewDidLoadModel:(UITableView *)tableView {
		...
		for (NSString *name in _addressBook.names) {
			...
			UXTableItem *item = [UXTableTextItem itemWithText:name URL:nil];
...
@implementation MockSearchDataSource
	...
	-(void) tableViewDidLoadModel:(UITableView *)tableView {
		self.items = [NSMutableArray array];
		for (NSString *name in _addressBook.names) {
			UXTableItem *item = [UXTableTextItem itemWithText:name URL:@"http://google.com"];

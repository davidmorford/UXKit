...
/*!
@project    JSONKit
@header     JKJSONErrorUnitTest.m.h
...
@interface JKJSONErrorUnitTest : SenTestCase {
	JKJSON *json;
}

@end

#define assertErrorContains(e, s)			STAssertTrue([[e localizedDescription] hasPrefix:s], @"%@", [e userInfo])
#define assertUnderlyingErrorContains(e, s) STAssertTrue([[[[e userInfo] objectForKey:NSUnderlyingErrorKey] localizedDescription] hasPrefix:s], @"%@", [e userInfo])

@implementation JKJSONErrorUnitTest

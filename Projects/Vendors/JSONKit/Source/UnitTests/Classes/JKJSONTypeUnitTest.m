...
@interface JKJSONTypeUnitTest : SenTestCase
@end
...
@implementation JKJSONTypeUnitTest
	...
	/*
	-(void) testNumbers {
		NSDictionary *numbers	= [file(@"../../Source/UnitTests/Resources/Data/Types/number.plist") propertyList];
	...
	*/
	...
	/*
	-(void) testString {
		NSDictionary *strings	= [file(@"../../Source/UnitTests/Resources/Data/Types/string.plist") propertyList];
	...
	*/
	...
	/*
	-(void) testArray {
		NSDictionary *dict			= [file(@"../../Source/UnitTests/Resources/Data/Types/array.plist") propertyList];
		NSEnumerator *enumerator	= [dict keyEnumerator];
	...
	*/
	...
	/*
	-(void) testObject {
		NSDictionary *dict			= [file(@"../../Source/UnitTests/Resources/Data/Types/object.plist") propertyList];
		NSEnumerator *enumerator	= [dict keyEnumerator];
		for (NSString *jsonrep; (jsonrep = [enumerator nextObject]); ) {
			id expected		= [dict objectForKey:jsonrep];
			id json			= [jsonrep JSONValue];
